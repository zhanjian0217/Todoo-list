...
loginform.addEventListener("submit", (e1)=>{
    e1.preventDefault();
    ...
    if (login_email.value.trim() !== "" && login_password.value.trim() !== "") {
        ...
        _axiosDefault.default.post('https://todoo.5xcamp.us/users/sign_in', userData).then((resp)=>{
            ...
            localStorage.setItem("MYtoken", token1);
            console.log("登入成功");
...
document.querySelector("#UL").addEventListener("click", (e)=>{
    if (e.target.nodeName === "BUTTON" && e.target.textContent === "修改") {
        ...
        _axiosDefault.default.put(`https://todoo.5xcamp.us/todos/${id}`, todo, {
            headers: {
                Authorization: token
            }
        });
...
},{}]},["d5kvp","igcvL"], "igcvL", "parcelRequire5d19")
